...
namespace WorldOfSuperMaket.Models
{
    public class UserInfo
    {
        ...
        public UserInfo(string x_Username)
        {
            ...
            Weaght = 70;
            Gender = "none";
            DaliyCalo = Convert.ToInt32(Math.Round(calcCalo(1.65, 70),0)*7);
            //if (Gender.Length > 4)
            //{
            ...
            //}
            DaliyKullhydrat = Convert.ToInt32(Math.Round(caleKulhydrat(DaliyCalo, 70),0)*7);
            DaliyProtien = Convert.ToInt32(Math.Round(caleProtien(DaliyCalo),0)*7);
            DaliyFat = Convert.ToInt32(Math.Round(caleFat(DaliyCalo),0)*7);
